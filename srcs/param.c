...
/*   Updated: 2020/11/27 09:35:00 by glamy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (info[0] == 'R')
		parse_resolution(game, info, C_R);
	else if (info[0] == 'N' && info[1] == 'O' && info[2] == ' ')
	...
	else if (info[0] == 'S' && info[1] == ' ')
		parse_texture(game, info, C_S);
